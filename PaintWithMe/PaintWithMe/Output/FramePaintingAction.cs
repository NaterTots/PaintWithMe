...
{
    class FramePaintingAction : IPaintingAction
    {
        ...
        static FramePaintingAction()
        {
            frameTexture = ServiceManager.Instance.GetService<TextureManager>(ServiceType.TextureManager).GetTexture("cartoon\\frame");
        ...
        {
            spriteBatch.Draw(frameTexture, new Rectangle(0, 0, screenHeight, screenWidth), null, Color.White, 0, new Vector2(0, 0), SpriteEffects.None, 1);
        }
